 ...
 * @author johnk
 */
public class AgentSalesReportUI extends javax.swing.JFrame {
     ...
     */
    public AgentSalesReportUI() throws SQLException {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Agent Sales Report");
    ...
    private void agentListBoxValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_agentListBoxValueChanged
        ...
        if (agentText != null) {
            ...
            ArrayList<Sale> agentSales = new ArrayList<Sale>();
            try {
                agentSales = saleDataService.GetByAgentId(agentId);
            } catch (SQLException ex) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AgentSalesReportUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
